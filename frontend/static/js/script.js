...
// ✅ CORREÇÃO 1: Importa o chatbot Sarcinha
...
async function setupMapAndCalendar() {
    ...
    try {
        ...
        // ✅ CORREÇÃO 2: Define uma foto da localização com o caminho 'static' correto
        locationPhoto.src = "/static/imgs/acs/igreja.png";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Funções de Conteúdo
    updateVisitorCount();
    setupGalleryCarousel(); // Substitui loadGallery()
    loadDocuments();
    ...
    const sarcinha = new Sarcinha(); // Garante a inicialização do chatbot
});
