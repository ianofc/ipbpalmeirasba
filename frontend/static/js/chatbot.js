...
// CORREÇÃO: Definindo o caminho da imagem do Sarcinha em uma constante para evitar repetição
const SARCINHA_AVATAR_SRC = '/static/imgs/icons/SARCAIPB.png';
...
                                                <img src="${SARCINHA_AVATAR_SRC}" alt="Sarcinha" class="w-10 h-10 rounded-full mr-3">
...
                                        <img src="${SARCINHA_AVATAR_SRC}" alt="Sarcinha" class="w-6 h-6 rounded-full">
                </button>
            </div>
        `;
...
                                ${type === 'bot' ? `<img src="${SARCINHA_AVATAR_SRC}" alt="Sarcinha" class="w-8 h-8 rounded-full mr-2">` : ''}
                <div>${text.replace(/\n/g, '<br>')}</div>
            </div>
        `;
